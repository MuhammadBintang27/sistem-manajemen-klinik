        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-green-50 via-white to-green-100">
            <div class="mb-8">
                <div class="flex flex-col items-center">
                    <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-green-600 to-green-700 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
            ...
            <div class="w-full sm:max-w-md px-6 py-8 bg-white border border-green-100 shadow-lg overflow-hidden rounded-2xl">
                {{ $slot }}
            </div>
        </div>
    </body>
