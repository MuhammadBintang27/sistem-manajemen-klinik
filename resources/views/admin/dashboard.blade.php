<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <span class="inline-flex items-center gap-2 px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-sm font-semibold">
                <span class="inline-flex h-3 w-3 rounded-full bg-primary-600 animate-pulse"></span>
    ...
    <div class="space-y-8">
        ...
        <div class="rounded-2xl bg-gradient-to-r from-primary-600 to-primary-700 shadow-lg overflow-hidden text-white">
            <div class="px-8 py-12 sm:px-10">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-widest text-primary-100">Selamat datang</p>
                        <h1 class="mt-3 text-4xl font-bold">Kelola Klinik dengan Cepat</h1>
                        <p class="mt-2 text-lg text-primary-100">Semua pengaturan pasien, jadwal, dan reservasi hadir di sini.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="rounded-2xl bg-white border border-primary-100 shadow-md hover:shadow-lg transition-shadow p-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-4 text-5xl font-bold text-primary-600">{{ $pasienCount }}</p>
            ...
            <div class="rounded-2xl bg-white border border-primary-100 shadow-md hover:shadow-lg transition-shadow p-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-4 text-5xl font-bold text-primary-600">{{ $jadwalCount }}</p>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <a href="{{ route('admin.pasien.index') }}" class="rounded-2xl bg-white border border-primary-100 shadow-md hover:shadow-lg hover:border-primary-300 transition-all p-6 text-center">
            ...
            <a href="{{ route('admin.jadwal.index') }}" class="rounded-2xl bg-white border border-primary-100 shadow-md hover:shadow-lg hover:border-primary-300 transition-all p-6 text-center">
                <div class="flex items-center justify-center h-14 w-14 rounded-xl bg-gradient-to-br from-primary-100 to-secondary-50 mx-auto mb-4">
                    <svg class="h-7 w-7 text-primary-600" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z"/>
                    </svg>
            ...
            <div class="rounded-2xl bg-gradient-to-br from-secondary-50 to-white border border-secondary-100 shadow-md p-6">
