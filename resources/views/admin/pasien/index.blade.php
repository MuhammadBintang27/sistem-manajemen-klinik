    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            ...
            <a href="{{ route('admin.pasien.create') }}"
               class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-xl transition-all shadow-md hover:shadow-lg">
        ...
        <div class="rounded-2xl bg-white border border-green-100 shadow-md overflow-hidden">
                            ...
                            <tr class="hover:bg-green-50 transition-colors">
                                ...
                                <td class="px-8 py-4 whitespace-nowrap text-sm">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('admin.pasien.show', $pasien) }}" class="inline-flex items-center gap-1 px-4 py-2 bg-green-100 hover:bg-green-200 text-green-700 font-medium rounded-xl transition-colors">
            ...
            @if ($pasiens->count() === 0)
                <div class="p-8 text-center">
                    ...
                    <p class="mt-4 text-sm text-slate-600">Belum ada data pasien. Mulai dengan <a href="{{ route('admin.pasien.create') }}" class="text-green-600 font-semibold hover:text-green-700">menambah pasien baru</a>.</p>
                </div>
            @endif
        </div>
