    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl bg-white border border-green-100 shadow-md overflow-hidden">
            <div class="bg-gradient-to-r from-green-600 to-green-700 px-8 py-6">
                ...
                <p class="mt-1 text-sm text-green-100">Kelola semua reservasi pasien dan dokter</p>
            </div>
                    ...
                    <tbody class="divide-y divide-green-100">
                        @foreach ($reservasis as $reservasi)
                            <tr class="hover:bg-green-50 transition-colors">
                                ...
                                <td class="px-8 py-4 text-sm">
                                    <a href="{{ route('admin.reservasi.show', $reservasi) }}" class="inline-flex items-center px-4 py-2 bg-green-100 hover:bg-green-200 text-green-700 font-medium rounded-xl transition-colors">
