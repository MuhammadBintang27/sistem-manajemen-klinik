                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.jadwal.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="kuota" class="block mt-1 w-full" type="number" name="kuota" min="1" max="100" :value="old('kuota', 5)" required />
                            <x-input-error :messages="$errors->get('kuota')" class="mt-2" />
                            <p class="text-sm text-gray-500 mt-1">Default: 5 (dapat disesuaikan)</p>
                        </div>
